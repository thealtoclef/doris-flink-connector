...
public class PostgresJsonDebeziumSchemaSerializer implements DorisRecordSerializer<String> {
    ...
    private void init() {
        JsonDebeziumChangeContext changeContext =
                new JsonDebeziumChangeContext(
                        ...
                        true,
                        tableNameConverter);
        this.dataChange = new PostgresJsonDebeziumDataChange(changeContext);
        this.schemaChange = new PostgresJsonDebeziumSchemaChange(changeContext);
    }
    ...
    private String getOperateType(JsonNode recordRoot) {
        return recordRoot.get("op").asText();
    }
